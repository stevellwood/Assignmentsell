    ...
    console.log("getting ready");
        ...
        $.ajax({url: "http://localhost:8080/student"}).then(function(result) {
            ...
            $(".del_student").click(function() {
                ...
                // $.ajax(
                //   {url: "http://localhost:8080/student_delete/" + id}
                // ).then(function() {
                  $.ajax({
...
//says the workflow is too convoluted to embed a clikc function in the ready
//we call the student list over and over so build it from there.
    // function refresh list
    // function reallydelete
    //   api.jquery.com/Queryl.ajax
    // function delete
